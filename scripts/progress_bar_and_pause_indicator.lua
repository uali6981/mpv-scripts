...
settings['enable-elapsed-time'] = false
...
settings['enable-remaining-time'] = false
...
settings['enable-hover-time'] = false
    ...
    redraw = function(self)
      ...
      if position ~= self.lastPosition or self.needsUpdate then
        ...
        --   local followingEdge = Window.w * position * 1e-2 - self.barShift
          self.line[7] = ([[\clip(m %g 0 l %g 0 %g %g %g %g)]]):format(Window.w, Window.w, Window.h, followingEdge, Window.h)
        end
